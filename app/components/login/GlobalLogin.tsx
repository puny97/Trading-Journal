  ...
  return (
    <section className="flex flex-col items-center justify-center min-h-screen bg-gray-150">
      <div className="flex flex-col items-center justify-center border border-gray-300 rounded-lg shadow-lg bg-white pb-15 pt-10 px-10">
        <div className="flex items-center justify-center mb-4 bg-accent rounded-lg p-3">
          <LuChartCandlestick size={20} color="white" />
        </div>
        ...
        <button
          className="flex items-center justify-center gap-2 mt-6 px-4 py-2 bg-accent text-white rounded-lg scale-100 hover:bg-accent-foreground hover:scale-110 transition-colors duration-300 cursor-pointer hover:shadow-lg hover:shadow-accent/50"
          type="submit"
        >
          <MdLock />
